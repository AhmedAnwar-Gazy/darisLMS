...
return new class extends Migration
{
    ...
    {
        // User competencies
        Schema::create('competency_usercomp', function (Blueprint $table) {
            $table->id('id');
            ...
            $table->tinyInteger('status')->default(0)->comment('Competency status.');
            $table->integer('reviewerid')->nullable()->comment('User that reviewed the competency.');
            ...
            // Unique Indexes
            $table->unique(['userid', 'competencyid'], 'useridcompetency');
    ...
    {
        Schema::dropIfExists('competency_usercomp');
    }
};
